...
citation = "${d.citation}"
<#else>
citation = "<#list d.authorsAndEditors as author>${author}<#sep>, </#list> (${d.released?string['yyyy']}). ${d.title}, ${d.released}. Digital resource at www.catalogueoflife.org/col. Species 2000: Naturalis, Leiden, the Netherlands. ISSN 2405-8858."
</#if>
