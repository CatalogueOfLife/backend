...
<!-- Table of contents generated generated by http://tableofcontent.eu -->
  - [Recommended reading](#recommended-reading)
    - [General Java books](#general-java-books)
    - [Git](#git)
    - [Maven](#maven)
  ...
  - [Best practices](#best-practices)
    ...
    - [TODOs](#todos)
    - [Obey the Law of Demeter ([LoD](http://en.wikipedia.org/wiki/Law_of_Demeter))](#obey-the-law-of-demeter-lodhttpenwikipediaorgwikilaw_of_demeter)
    - [Don't Repeat Yourself ([DRY](http://en.wikipedia.org/wiki/Don't_repeat_yourself))](#dont-repeat-yourself-dryhttpenwikipediaorgwikidont_repeat_yourself)
...
TODO
 ...
 - resolving dependency conflicts: https://maven.apache.org/plugins/maven-dependency-plugin/examples/resolving-conflicts-using-the-dependency-tree.html
...
### Neo4j
We use Neo4j only as an [embedded database](https://neo4j.com/docs/java-reference/3.2/#tutorials-java-embedded), not in the default server mode.
It is worth reading the documentation on the [traversal framework](https://neo4j.com/docs/java-reference/3.2/#tutorials-java-embedded-traversal) which we use a lot
and the [Cypher query language](https://neo4j.com/docs/developer-manual/current/cypher/).
