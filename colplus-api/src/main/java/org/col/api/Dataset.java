...
public class Dataset {
	...
	@Override
	public int hashCode() {
		return Objects.hash(key, alias, title, gbifKey, description, groupName, authorsAndEditors,
		    organisation, contactPerson, version, releaseDate, taxonomicCoverage, coverage,
		    completeness, confidence, homepage, dataFormat, dataAccess, notes, created, modified,
		    deleted);
	}
