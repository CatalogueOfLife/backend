...
public enum TypeStatus {
   ...
   * The term is not regulated by the ICZN. [Zoo.]
   */
  ALLOLECTOTYPE,
  ...
  /**
   * A paratype specimen designated from the type series by the original author
   * that is the opposite sex of the holotype.
   * The term is not regulated by the ICZN. [Zoo.]
   */
  ALLOTYPE,
  
  /**
   * A deprecated term no longer recognized in the ICZN;
   * formerly used for either syntype or paratype [see ICZN Recommendation 73E]. [Zoo.]
   */
  COTYPE,
   ...
   * and cannot be critically identified for purposes of the precise application of the name of a taxon (see Art. ICBN 9.7, 9.18).
   * An epitype supplements, rather than replaces existing types. [Bot./Bio.]
   */
  EPITYPE,
   ...
   * Ex-types are not regulated by the botanical or zoological code. [Bot.]
   */
  EXEPITYPE,
  
  /**
   * A strain or cultivation derived from holotype material.
   * Ex-types are not regulated by the botanical or zoological code. [Zoo./Bot.]
   */
  EXHOLOTYPE,
   ...
   * components may be excluded until it contains individuals of only one species [ICZN Article 73.3.2]. [Zoo.]
   */
  HAPANTOTYPE,
   ...
   * or 'implicit' if it is the single specimen proved to have been in the hands of the originating author when the description was published. [Zoo./Bot./Bio.]
   */
  HOLOTYPE,
  
  /**
   * A drawing or photograph (also called 'phototype') of a type specimen.
   * Note: the term 'iconotype' is not used in the ICBN, but implicit in, e. g., ICBN Art. 7 and 38. [Zoo./Bot.]
   */
  ICONOTYPE,
   ...
   * from which the holotype was derived); it is always a specimen (ICBN Art. 7). [Bot.]
   */
  ISOTYPE,
   ...
   * or if it is missing (ICBN Art. 7, ICZN Art. 74). [Zoo./Bot.]
   * Note: the BioCode defines lectotype as selection from holotype material in cases where the holotype material contains more than one taxon [Bio.].
   */
  LECTOTYPE,
  
  /**
   * A specimen designated as nomenclatural type subsequent to the publication of the original description
   * in cases where the original holotype, lectotype, all paratypes and syntypes are lost or destroyed, or suppressed by the (botanical or zoological) commission on nomenclature.
   * In zoology also called 'Standard specimen' or 'Representative specimen'. [Zoo./Bot./Bio.]
   */
  NEOTYPE,
  
  /**
   * All of the specimens in the syntype series of a species or infraspecific taxon other than the lectotype itself.
   * Also called 'lectoparatype'. [Zoo.]
   */
  PARALECTOTYPE,
  
  /**
   * All of the specimens in the syntype series of a species or infraspecific taxon other than the neotype itself.
   * Also called 'neoparatype'. [Zoo.]
   */
  PARANEOTYPE,
   ...
   * but usually as 'specimens examined,' 'other material seen', etc. [Zoo./Bot.]
   */
  PARATYPE,
   ...
   * The syntypes collectively constitute the name-bearing type. [Zoo./Bot.]
   */
  SYNTYPE,
