...
/**
 * Simple manual utility to merge new synonym entries into a single, clean dictionary file to be
 * picked up by the nub lookup and hosted at http://rs.gbif.org/dictionaries/synonyms/
 */
