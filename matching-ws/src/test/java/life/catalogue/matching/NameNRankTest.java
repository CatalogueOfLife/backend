...
class NameNRankTest {
  ...
  void build() {
    ...
    assertName("Lepidothrix iris L.", "", "L.", null, "iris", "", cl);
    assertName("Lepidothrix iris L.", "L. iris", "L.", null, "", "null", cl);
    assertName("Lepidothrix iris L.", "L. iris", "L.", "Lepidothrix", "", null);
    assertName("L. iris", "L. iris", "L.", null, "", null, null);
    assertName("L. iris Miller", "L. iris", "Miller", null, "", null, null);

    cl.setSpecies("iris");
    assertName("Lepidothrix iris L.", "iris", "L.", null, "", null, cl);
    cl.setSpecies("Lepidothrix iris");
    assertName("Lepidothrix iris L.", null, "L.", null, "", null, cl);

    // without classification
    assertName("Lepidothrix iris L.", null, "L.", "Lepidothrix", "iris", null, cl);
    assertName(
        "Lepidothrix iris var. alpina L.",
        Rank.VARIETY,
        null,
        "L.",
        "Lepidothrix",
  ...
  void assertName(
    ...
    assertName(
        expected, null, name, authorship, genericName, specificEpithet, infraSpecificEpithet);
  }
  ...
  void assertGoodName(String name, String authorship) {
    assertEquals(
        new NameNRank(name, null), NameNRank.build(name, authorship, null, null, null, null, null));
  }
  ...
  void expandAbbreviatedGenus() {
    ...
    assertEquals(
        "xecrtvfzgbhnjml,mtre", NameNRank.expandAbbreviatedGenus("xecrtvfzgbhnjml,mtre", "Abies"));
