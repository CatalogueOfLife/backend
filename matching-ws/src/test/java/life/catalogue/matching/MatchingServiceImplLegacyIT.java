...
public class MatchingServiceImplLegacyIT {
  //
  ...
  //    cl.setKingdom(null);
  //    cl.setPhylum(".");
  //    matcher.match(null, null, "---", null, cl, null, NubMatchingServiceImpl.MatchingMode.FUZZY,
  // true);
  //
  ...
  //    matcher.match(null, null, "FAMILY", null, cl, null,
  // NubMatchingServiceImpl.MatchingMode.FUZZY, true);
  //  }
  //
  //   @Test
  //   public void testNoMatch() throws IOException {
  //     LinneanClassification cl = new NameUsageMatch();
  //     NameUsageMatch m = matcher.match(null, null, "", null, cl, null,
  // NubMatchingServiceImpl.MatchingMode.FUZZY, true);
  ...
  //  }
  //
  //  private void assertMatchedUsageKey(String name, LinneanClassification query, Integer
  // expectedKey) {
