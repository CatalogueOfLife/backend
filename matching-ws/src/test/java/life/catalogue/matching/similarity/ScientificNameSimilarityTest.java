...
public class ScientificNameSimilarityTest {
  ...
  public void testSimilarities() throws Exception {
    ...
    assertEquals(
        93.33d,
        sns.getSimilarity("Linaria pedunculata vulgaris", "Lunaria pedunculata vulgaris"),
        0.01d);
    assertEquals(
        5d,
        sns.getSimilarity("Linaria pedunculata vulgaris", "Linaria pedunculata vandalis"),
        0.01d);
