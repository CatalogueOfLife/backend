...
public class NameUsageSearchRequestTest extends SerdeTestBase<NameUsageSearchRequest> {
  ...
  public void jsonConstructor() {
    // all nulls
    NameUsageSearchRequest r = new NameUsageSearchRequest(null,null,null,null,null,null,false,null,null,null);
    // empty collections
    r = new NameUsageSearchRequest(Map.of(), Set.of(), null, Set.of(),null,null,false,null,null,null);
  }
