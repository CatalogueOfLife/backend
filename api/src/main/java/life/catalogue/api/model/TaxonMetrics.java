...
public class TaxonMetrics extends DatasetScopedEntityNotManaged<String> {
  ...
  public boolean equals(Object o) {
    ...
    return depth == that.depth && maxDepth == that.maxDepth && taxonCount == that.taxonCount && speciesCount == that.speciesCount && childCount == that.childCount && childExtantCount == that.childExtantCount && Objects.equals(taxaByRankCount, that.taxaByRankCount) && Objects.equals(speciesBySourceCount, that.speciesBySourceCount) && Objects.equals(classification, that.classification);
  }

  @Override
  public int hashCode() {
    return Objects.hash(depth, maxDepth, taxonCount, speciesCount, childCount, childExtantCount, taxaByRankCount, speciesBySourceCount, classification);
  }
}
