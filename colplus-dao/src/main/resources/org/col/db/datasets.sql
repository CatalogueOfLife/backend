...
('1205', 0, 0, true,  1, 'INA',               1, 0, 0, 3, 'https://github.com/mdoering/data-ina/archive/master.zip');

UPDATE dataset set alias=title WHERE key IN (1027,1055,1074,1140,1141,1163,1202,1203,1204,1205, 1600,1601,1602,1700);
