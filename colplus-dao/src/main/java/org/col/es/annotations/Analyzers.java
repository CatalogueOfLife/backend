 ...
 * {@link Analyzer#IGNORE_CASE} analyzer while enum fields will only be indexed using the
 * {@link Analyzer#IGNORE_CASE} analyzer (full-text search would ordinarily not make sense for
