...
import static org.col.es.name.search.NameFacetLabels.getContextFilterLabel;
import static org.col.es.name.search.NameFacetLabels.getContextLabel;
import static org.col.es.name.search.NameFacetLabels.getFacetLabel;
import static org.col.es.name.search.translate.NameSearchRequestTranslator.generateQuery;
