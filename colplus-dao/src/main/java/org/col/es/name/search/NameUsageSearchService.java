...
import org.col.es.name.search.translate.NameSearchRequestTranslator;
...
public class NameUsageSearchService {
  ...
  @VisibleForTesting
  public NameSearchResponse search(String index, NameSearchRequest colSearchRequest, Page page) throws IOException {
