...
/**
 * Class representing a complex structure within an Elasticsearch type mapping. This can be either
 * the entire type mapping or a nested document (objects with datatype "nested" or "object"). The
