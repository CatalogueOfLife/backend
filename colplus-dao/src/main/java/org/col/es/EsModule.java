 ...
 * to (de)serialize data stored in Elastic Search.
 * <p>
...
public class EsModule extends SimpleModule {
  ...
  public static final ObjectWriter NAME_USAGE_WRITER = MAPPER.writerFor(
      new TypeReference<NameUsageWrapper<? extends NameUsage>>() {
      }
  );

  public static final ObjectReader NAME_USAGE_READER = MAPPER.readerFor(
      new TypeReference<NameUsageWrapper<? extends NameUsage>>() {
      }
  );
