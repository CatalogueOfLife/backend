...
/**
 * Determines and provides the labels to use for the various facets. We need to centralize this so that the query generators use the same
 * labels as the result parsers.
 */
public class NameUsageFacetLabels {

  public static final String FACET_LABEL_SUFFIX = "_FACET";

//  static final String DATASET_KEY_FACET = DATASET_KEY.getFacetLabel();
//  static final String CATALOGUE_KEY_FACET = CATALOGUE_KEY.getFacetLabel();
//  static final String SECTOR_DATASET_KEY_FACET = SECTOR_DATASET_KEY.getFacetLabel();
//  static final String DECISION_MODE_FACET = DECISION_MODE.getFacetLabel();
//  static final String FIELD_FACET = FIELD.getFacetLabel();
//  static final String ISSUE_FACET = ISSUE.getFacetLabel();
...
//  static final String ALPHAINDEX_FACET = "RECENT_FACET";
...
//    facetLabels.put(ALPHAINDEX, ALPHAINDEX_FACET);
//
