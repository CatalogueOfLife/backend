...
INSERT INTO name (dataset_key, id, homotypic_name_id, verbatim_key, scientific_name, genus, specific_epithet, rank, origin, type, created_by, modified_by) VALUES (11, 'http://services.snsb.info/DTNtaxonlists/rest/v0.1/names/DiversityTaxonNames_Insecta/5009538/', 'name-4', null, 'Apia apis', 'Apia', 'apis', 'species'::rank, 0, 0, 0, 0);
...
INSERT INTO name (dataset_key, id, homotypic_name_id, verbatim_key, scientific_name, genus, specific_epithet, rank, origin, type, created_by, modified_by) VALUES (11, 'name-2', 'name-2', null, 'Larus fuscus', 'Larus', 'fuscus', 'species'::rank, 0, 0, 0, 0);
