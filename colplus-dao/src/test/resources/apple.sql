...
INSERT INTO name (dataset_key, id, homotypic_name_id, scientific_name, genus, specific_epithet, rank, origin, type, created_by, modified_by) VALUES (11, 'http://services.snsb.info/DTNtaxonlists/rest/v0.1/names/DiversityTaxonNames_Insecta/5009538/', 'name-4', 'Apia apis', 'Apia', 'apis', 'species'::rank, 0, 0, 1, 1);
INSERT INTO name (dataset_key, id, homotypic_name_id, scientific_name, genus, specific_epithet, rank, origin, type, created_by, modified_by, published_in_id, published_in_page) VALUES (11, 'name-1', 'name-1', 'Malus sylvestris', 'Malus', 'sylvestris', 'species'::rank, 0, 0, 1, 1, 'ref-1', '712');
INSERT INTO name (dataset_key, id, homotypic_name_id, scientific_name, genus, specific_epithet, rank, origin, type, created_by, modified_by) VALUES (11, 'name-2', 'name-2', 'Larus fuscus', 'Larus', 'fuscus', 'species'::rank, 0, 0, 1, 1);
INSERT INTO name (dataset_key, id, homotypic_name_id, scientific_name, genus, specific_epithet, rank, origin, type, created_by, modified_by) VALUES (11, 'name-3', 'name-2', 'Larus fusca', 'Larus', 'fusca', 'species'::rank, 0, 0, 1, 1);
INSERT INTO name (dataset_key, id, homotypic_name_id, scientific_name, genus, specific_epithet, rank, origin, type, created_by, modified_by) VALUES (11, 'name-4', 'name-4', 'Larus erfundus', 'Larus', 'erfundus', 'species'::rank, 0, 0, 1, 1);

INSERT INTO taxon (id, dataset_key, name_id, origin, created_by, modified_by) VALUES ('root-1', 11, 'name-1', 0, 1, 1);
INSERT INTO taxon (id, dataset_key, name_id, origin, created_by, modified_by) VALUES ('root-2', 11, 'name-2', 0, 1, 1);
