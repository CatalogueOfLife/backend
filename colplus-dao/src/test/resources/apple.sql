...
INSERT INTO name (key, dataset_key, id, scientific_name, genus, specific_epithet, rank, origin, type) VALUES (1, 1, 'name-1', 'Malus sylvestris', 'Malus', 'sylvestris', 'species'::rank, 0, 0);
INSERT INTO name (key, dataset_key, id, basionym_key, scientific_name, genus, specific_epithet, rank, origin, type) VALUES (2, 1, 'name-2', 2, 'Larus fuscus', 'Larus', 'fuscus', 'species'::rank, 0, 0);
INSERT INTO name (key, dataset_key, id, basionym_key, scientific_name, genus, specific_epithet, rank, origin, type) VALUES (3, 1, 'name-3', 2, 'Larus fusca', 'Larus', 'fusca', 'species'::rank, 0, 0);
INSERT INTO name (key, dataset_key, id, scientific_name, genus, specific_epithet, rank, origin, type) VALUES (4, 1, 'name-4', 'Larus erfundus', 'Larus', 'erfundus', 'species'::rank, 0, 0);
...
INSERT INTO name_act (key, dataset_key, type, status, name_key, related_name_key) VALUES (1, 1, 2, 1, 3, 2);
