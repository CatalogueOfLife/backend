...
ALTER TABLE nidx.name_usage_archive_match ADD PRIMARY KEY (dataset_key, usage_id);
CREATE INDEX ON nidx.name_usage_archive_match (dataset_key, index_id);
CREATE INDEX ON nidx.name_usage_archive_match (index_id);
