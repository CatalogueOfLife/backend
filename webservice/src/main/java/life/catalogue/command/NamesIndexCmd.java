...
public class NamesIndexCmd extends AbstractMybatisCmd {
  ...
  protected static Name nextName(PgBinaryReader r) throws IOException {
    ...
    return Name.newBuilder()
                 ...
                 .basionymAuthorship(new ExAuthorship(r.readStringArray(),r.readStringArray(),r.readString()))
                 .combinationAuthorship(new ExAuthorship(r.readStringArray(),r.readStringArray(),r.readString()))
                 .emendAuthorship(new Authorship(r.readStringArray(),r.readString()))
