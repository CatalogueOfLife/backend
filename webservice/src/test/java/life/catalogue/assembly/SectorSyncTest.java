...
//      n.setHomotypicNameId("cole");
  ...
  public void sync() throws Exception {
    ...
    SectorSync ss = SectorSync.withDelete(sector, PgSetupRule.getSqlSessionFactory(), NameIndexFactory.passThru(), NameUsageIndexService.passThru(), sdao, siDao, eDao,
    ...
    ss = SectorSync.withDelete(sector, PgSetupRule.getSqlSessionFactory(), NameIndexFactory.passThru(), NameUsageIndexService.passThru(), sdao, siDao, eDao,
        SectorSyncTest::successCallBack, SectorSyncTest::errorCallBack, TestEntityGenerator.USER_EDITOR);
    ss.run();
