...
public class ImportManagerLiveTest {
  ...
  public void init() throws Exception {
    ...
    importManager = new ImportManager(cfg, metrics, hc, new EventBus("test-bus"), SqlSessionFactoryRule.getSqlSessionFactory(),
        NameIndexFactory.passThru(), diDao, datasetDao, sDao, dDao, indexService, new ImageServiceFS(cfg.img, null), jobExecutor, validator, null);
    importManager.start();
  ...
  public void submitAndCancel() throws Exception {
    ...
    importManager.submit(ImportRequest.external(d4.getKey(), Users.IMPORTER, false, true));
