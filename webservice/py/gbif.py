...
class ClbUser(FastHttpUser):
  ...
  @task(3)
  def match(self):
    with self.rest("GET", "/v2/species/match", scientificName=random.choice(names), scientificNameAuthorship=random.choice(authors), bust=random.randint(1, 99999999999)) as resp:
      pass
