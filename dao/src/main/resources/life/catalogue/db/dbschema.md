...
ALTER TYPE ISSUE ADD VALUE 'DUPLICATE_MEDIA';
ALTER TYPE ISSUE ADD VALUE 'DUPLICATE_VERNACULAR_NAMES';
ALTER TYPE ISSUE ADD VALUE 'DUPLICATE_ESTIMATES';
ALTER TYPE ISSUE ADD VALUE 'DUPLICATE_TAXON_PROPERTIES';
```
...
ALTER TYPE ISSUE ADD VALUE 'MISSPELLING_CONSOLIDATION';
```
