...
CREATE TYPE ISSUE AS ENUM (
  ...
  'NOMINOTYPICAL_AUTHORSHIP_DIFFERS',
...
CREATE TABLE dataset (
  ...
  -- unique index on doi ignoring deleted datasets
...
CREATE INDEX ON estimate (dataset_key, verbatim_key);
