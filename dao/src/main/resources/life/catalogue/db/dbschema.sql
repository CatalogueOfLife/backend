...
CREATE TABLE dataset_import_mod0 PARTITION OF dataset_import FOR VALUES WITH (modulus 3, remainder 0);
CREATE TABLE dataset_import_mod1 PARTITION OF dataset_import FOR VALUES WITH (modulus 3, remainder 1);
CREATE TABLE dataset_import_mod1 PARTITION OF dataset_import FOR VALUES WITH (modulus 3, remainder 2);
