...
public interface DatasetImportMapper extends DatasetProcessable<DatasetImport> {
  ...
  List<StringCount> countMergedSynonymsByRank(@Param("key") int datasetKey);
  List<StringCount> countMergedTaxaByRank(@Param("key") int datasetKey);
  ...
  List<StringCount> countSecondarySourceByInfo(@Param("key") int datasetKey);
