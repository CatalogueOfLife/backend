...
public class DatasetImportDao {
  ...
  /**
   * Finalizes a successful import, persisting the metrics generated by updateMetrics along with the
   * finish date. The job status itself is tracked on the job record.
   */
