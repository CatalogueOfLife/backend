...
abstract class NameUsageBaseDao<T extends NameUsageBase, M extends CRUD<DSID<String>, T> & DatasetPageable<T> & DatasetProcessable<T>> extends SectorEntityDao<T, M> {
   ...
   */
  public NameUsageBaseDao(Class<T> clazz, Class<M> mapperClass, SqlSessionFactory factory, NameDao nameDao, NameUsageIndexService indexService, Validator validator) {
