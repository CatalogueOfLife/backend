...
public class DotPrinterTest {
  ...
  public void print() throws IOException {
    ...
    int count = PrinterFactory.dataset(DotPrinter.class, TestDataRule.TREE.key, null, true, null, null, Rank.SPECIES, taxonCounter, PgSetupRule.getSqlSessionFactory(), writer).print();
