...
public class DotPrinterTest {
  ...
  public void print() throws IOException {
    ...
    int count = PrinterFactory.dataset(DotPrinter.class, TreeTraversalParameter.dataset(TestDataRule.TREE.key), null, Rank.SPECIES, taxonCounter, PgSetupRule.getSqlSessionFactory(), writer).print();
