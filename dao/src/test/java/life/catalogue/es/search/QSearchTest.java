...
public class QSearchTest extends EsReadTestBase {
  ...
  void indexParusMajor(){
    ...
    name.setGenus("Parus");
    name.setSpecificEpithet("major");
    name.setInfraspecificEpithet("major");
    name.setScientificName("Parus major major");
    t = new Taxon();
    t.setId("2");
    t.setName(name);
    nuw = new NameUsageWrapper(t);
    index(nuw);
  }
  ...
  public void test10() {
    ...
    assertEquals("COVID-19",response.getResult().get(0).getUsage().getLabel());
  }
