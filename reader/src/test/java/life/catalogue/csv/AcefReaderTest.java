...
public class AcefReaderTest {
  ...
  public void fromFolder() throws Exception {
    AcefReader reader = AcefReader.from(Resources.toPath("acef/0"));
  ...
  public void corruptFiles() throws Exception {
    AcefReader reader = AcefReader.from(Resources.toFile("acef/corrupt").toPath());
  ...
  public void fromDataFolder() throws Exception {
    AcefReader reader = AcefReader.from(Resources.toPath("acef/0data"));
