...
import static org.col.api.vocab.Severity.*;
...
public enum Issue {
   ...
   */
  SCIENTIFIC_NAME_ASSEMBLED(INFO),
   ...
   */
  CLASSIFICATION_RANK_ORDER_INVALID(ERROR),
