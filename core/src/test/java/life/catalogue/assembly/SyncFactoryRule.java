...
public class SyncFactoryRule extends ExternalResource {
  ...
  protected void before() throws Throwable {
    ...
    syncFactory = new SyncFactory(SqlSessionFactoryRule.getSqlSessionFactory(), matcherFactory, NameMatchingRule.getIndex(), sdao, siDao, eDao, NameUsageIndexService.passThru(), TestUtils.mockedBroker(), null, null);
  }
