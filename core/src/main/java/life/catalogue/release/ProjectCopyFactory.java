...
public class ProjectCopyFactory {
  ...
  public XRelease buildExtendedRelease(final int releaseKey, final int userKey) {
    return new XRelease(factory, syncFactory, matcher.getNameIndex(), indexService, imageService, dDao, diDao, siDao, rDao, nDao, sDao, releaseKey, userKey,
  ...
  public XRelease buildDebugXRelease(final int releaseKey, final int userKey) {
    return new XReleaseDebug(factory, syncFactory, matcher.getNameIndex(), indexService, imageService, dDao, diDao, siDao, rDao, nDao, sDao, releaseKey, userKey,
      cfg, doiCfg, apiURI, clbURI, client, exportManager, doiService, doiUpdater, validator);
  }
