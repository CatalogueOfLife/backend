...
public abstract class AbstractMatchingJob extends DatasetBlockingJob {
  ...
  // job specifics
  protected final MatchingRequest req;
  protected final JobResult result;
  ...
  public AbstractMatchingJob(MatchingRequest req, int userKey, Dataset dataset, List<? extends SimpleName> rootClassification,
    ...
    this.logToFile = true;
    this.cfg = cfg;
    this.utils = new MatchingUtils(nidx);
  ...
  /**
   * Only needed for source dataset requests
   */
  ...
  public boolean isDuplicate(BackgroundJob other) {
    if (other instanceof AbstractMatchingJob) {
      var mj = (AbstractMatchingJob) other;
