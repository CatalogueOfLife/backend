...
public class InterpreterBaseTest {
  ...
  private void assertDistributions(Gazetteer std, String loc, String expectedID) {
    assertDistributions(std, loc, std, expectedID, null);
  }
  private void assertDistributions(Gazetteer std, String loc, String expectedID, String expectedName) {
    assertDistributions(std, loc, std, expectedID, expectedName);
  }
  private void assertDistributions(Gazetteer std, String loc, Gazetteer expectedGazetteer, String expectedID, String expectedName) {
    ...
    assertEquals(expectedID, d.getArea().getId());
    assertEquals(expectedName, d.getArea().getName());
  }
}
